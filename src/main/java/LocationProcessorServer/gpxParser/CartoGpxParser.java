...
public class CartoGpxParser {
    ...
    private static class GpxHandler extends DefaultHandler {
            ...
            try {
                if (NODE_WAYPOINT.equals(localName)) {
                    ...
                    if (mCurrentTrackSegment != null) {
                        mCurrentTrackSegment
                                .addPoint(mCurrentTrackPoint = new TrackPoint());
        ...
        public void endElement(String uri, String localName, String name)
            ...
            if (NODE_WAYPOINT.equals(localName)) {
                ...
                if (mCurrentTrackSegment != null) {
                    mCurrentTrackSegment.setName(mStringAccumulator
                            .toString());
                } else if (mCurrentWayPoint != null) {
                    mCurrentWayPoint.setName(mStringAccumulator
                            .toString());
                }
            } else if (NODE_TIME.equals(localName)) {
                if (mCurrentTrackPoint != null) {
                    mCurrentTrackPoint
                            .setTime(computeTime(mStringAccumulator
                                    .toString()));
                }
                ...
                if (mCurrentTrackPoint != null) {
                    mCurrentTrackPoint
                            .setElevation(Double
                                    .parseDouble(mStringAccumulator
                                            .toString()));
                } else if (mCurrentWayPoint != null) {
                    mCurrentWayPoint
                            .setElevation(Double
                ...
                if (mCurrentWayPoint != null) {
                    mCurrentWayPoint.setDescription(mStringAccumulator
                            .toString());
                }
            }
        }
            ...
            if (m.matches()) {
                ...
                try {
                    ...
                    if (subSecondGroup != null) {
                        milliseconds = (int) (1000 * Double
                                .parseDouble(subSecondGroup));
                    }
         ...
         */
        private void handleLocation(LocationPoint locationNode,
     ...
     */
    public CartoGpxParser(String fileName) {
        mFileName = fileName;
    }
    ...
    public boolean parse() {
        try {
            ...
            parser.parse(new InputSource(new FileReader(mFileName)),
                    mHandler);
